...
\title{Reader's Digest and Regurgitation: A Multi-Dimensional NLP Pipeline for News Genre Classification,
...
{\small
\textsuperscript{1}Universidad de Cantabria, Santander, Cantabria, Spain}\\
...
We acknowledge the use of \textit{GitHub Copilot} for assistance in writing and
